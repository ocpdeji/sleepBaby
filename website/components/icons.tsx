...
export function HeartIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M12 20.3S5.5 16.2 4.1 10.9C3.2 7.4 5 5 7.6 5c1.8 0 3.1 1 4.4 2.8C13.3 6 14.6 5 16.4 5c2.6 0 4.4 2.4 3.5 5.9C18.5 16.2 12 20.3 12 20.3Z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
...
export function DownloadIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M12 4v10m0 0 4-4m-4 4-4-4M5 16v3h14v-3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function UserIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M20 21a8 8 0 0 0-16 0M12 13a5 5 0 1 0 0-10 5 5 0 0 0 0 10Z" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  );
}
